...
def main():
    ...
    add_endpoint_force(sim, rod_0, force=[0.0, 0.0, 10.0], ramp_up_time=0.1)
    add_endpoint_force(sim, rod_0, force=[0.0, 0.0, -10.0], ramp_up_time=0.1)
    # Process Connections
    # Connection: Rod 0 (end) -> Rod 0 (start) (Hinge)
    connect_hinge(sim, rods[0], rods[0], index_one=-1, index_two=0, normal=[0.0, 1.0, 0.0])
    ...
    data = {'rods': history_list, 'metadata': {'fps': 60}}
