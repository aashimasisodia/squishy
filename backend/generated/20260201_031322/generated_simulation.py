...
def main():
    ...
    add_muscle_activity(sim, rod_0, amplitude=0.02, wave_length=0.2, frequency=2.0, phase=0.0, ramp=0.1)
    add_anisotropic_friction(sim, rod_0, static_friction=[0.1, 0.1, 0.5], kinetic_friction=[0.05, 0.05, 0.3], plane_normal=[0.0, 0.0, 1.0], plane_origin=[0.0, 0.0, 0.0])
    # 3. Setup Diagnostics
    history_list = []
    for rod in rods:
