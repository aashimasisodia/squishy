...
def main():
    ...
    rods.append(rod_0)
    add_muscle_activity(sim, rod_0, amplitude=0.02, wave_length=0.05, frequency=2.0, phase=0.0, ramp=0.1)
    add_anisotropic_friction(sim, rod_0, static_friction=[0.1, 0.1, 0.1], kinetic_friction=[0.05, 0.05, 0.05], plane_normal=[0.0, 0.0, 1.0], plane_origin=[0.0, 0.0, 0.0])
    # Rod 1 (soft_biological_tissue)
    rod_1 = make_rod(
        sim,
        n_elem=10,
        length=0.1,
    ...
    rods.append(rod_1)
    add_muscle_activity(sim, rod_1, amplitude=0.02, wave_length=0.05, frequency=2.0, phase=0.0, ramp=0.1)
    add_anisotropic_friction(sim, rod_1, static_friction=[0.1, 0.1, 0.1], kinetic_friction=[0.05, 0.05, 0.05], plane_normal=[0.0, 0.0, 1.0], plane_origin=[0.0, 0.0, 0.0])
    # Rod 2 (soft_biological_tissue)
    rod_2 = make_rod(
        sim,
        n_elem=10,
        length=0.1,
    ...
    rods.append(rod_2)
    add_muscle_activity(sim, rod_2, amplitude=0.02, wave_length=0.05, frequency=2.0, phase=0.0, ramp=0.1)
    add_anisotropic_friction(sim, rod_2, static_friction=[0.1, 0.1, 0.1], kinetic_friction=[0.05, 0.05, 0.05], plane_normal=[0.0, 0.0, 1.0], plane_origin=[0.0, 0.0, 0.0])
    # Process Connections
    # Connection: Rod 0 (end) -> Rod 1 (start) (Spherical)
    connect_spherical(sim, rods[0], rods[1], index_one=-1, index_two=0)
    # Connection: Rod 1 (end) -> Rod 2 (start) (Spherical)
    connect_spherical(sim, rods[1], rods[2], index_one=-1, index_two=0)
