...
def main():
    ...
    # Connection: Rod 2 (end) -> Rod 3 (start) (Spherical)
    connect_spherical(sim, rods[2], rods[3], index_one=-1, index_two=0)
    # Connection: Rod 3 (end) -> Rod 4 (start) (Spherical)
    connect_spherical(sim, rods[3], rods[4], index_one=-1, index_two=0)
